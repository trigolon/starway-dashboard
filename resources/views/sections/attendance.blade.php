                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        $date = new DateTime($at->clock_in); 
                                        $day = $date->format('d-m-y');
                                        $time = $date->format('H:i');
                                        $targetTime = new DateTime('09:50');
                                        $targetTime = $targetTime->format('H:i');
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $at->employee->name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                @if ($time > $targetTime)
                                                    <span class="badge badge-sm bg-gradient-danger">{{ $time }}</span>
                                                @else
                                                    <span class="badge badge-sm bg-gradient-success">{{ $time }}</span>
                                                @endif
                                            </td>
